...
class AttendancePreview extends StatefulWidget {
  const AttendancePreview({super.key});

  @override
  State<AttendancePreview> createState() => _AttendancePageState();
}

class _AttendancePageState extends State<AttendancePreview> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4,),
                  Text('Mobile No. :$location1, $location2',style: TextStyle(color: Colors.white,fontSize: 16),)
                ],
              ),
            ),
            SizedBox(height: 20,),
